...
namespace VitaDiet.Controllers
{
    public class HISTORIALsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,IDPACIENTE,HISTORIAL1,HISTORIAL11")] HISTORIAL hISTORIAL)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,IDPACIENTE,HISTORIAL1,HISTORIAL11")] HISTORIAL hISTORIAL)
        {
            if (ModelState.IsValid)
            {
